# Program: rp_pause_maint.ps1
# Usage: rp_pause_maint.ps1
...
if (!$id) {
   Write-Error "usage: rp_pause_maint.ps1 id"
   exit
}
...
$url = $env:RP_SCHEME + $env:RP_DOMAIN + $env:RP_BASE_URL + "/checks/" + $id + '?maintenance=1'
...
Write-Error "info: start maintenance on one check"
