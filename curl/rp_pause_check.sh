...
# Usage:  ./rp_pause_check.sh checkid
...
curl $options $auth_options -H 'Accept: application/json' -H 'Accept-Charset: utf-8' -H "App-key: $RP_API_KEY" -X PUT ${url}/checks/$id?paused=1 -w "\n"
ret=$?
echo -e "ret=$ret\n"
