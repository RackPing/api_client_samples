...
# Program: rp_del_check.sh
# Usage: ./rp_del_check.sh id
# Date: 2020 10 05
...
wget $ENABLE_DEBUG --post-data '' $options $auth_options --header='X-HTTP-Method-Override: DELETE' --header="App-key: $api_key" --header="Accept-Charset: utf-8" ${url}/checks/$id
ret=$?
