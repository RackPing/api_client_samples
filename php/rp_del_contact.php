...
function do_curl($method, $endpoint, $user, $pw, $api_key, $timeout, $data) {
   // echo "method=$method, url=$endpoint, user=$user, pw=$pw, api_key=$api_key, timeout=$timeout, data=$data\n";
   ...
   $response = do_curl('DELETE', $url . '/contacts/' . $id, $user, $password, $api_key, $timeout, "");
