# RackPing API 2.0 Client Sample Node.js Programs

Node.js sample programs that you can copy-and-paste to automate common RackPing monitoring tasks from the command line or cron.
...
Tested with Node.js v0.10.48, but earlier and later versions will also very likely work.
